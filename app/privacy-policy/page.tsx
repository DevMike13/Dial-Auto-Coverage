  ...
  return (
    <div className='bg-white w-full h-auto flex justify-center items-center flex-col'>
        <div className='p-6 w-full md:max-w-[780px] m-auto pt-10'>
          ...
          <p>Dial Auto Coverage ("us", "we", or "our") operates the <a href="https://dialautocoverage.com/" className='text-blue-500 underline'>https://dialautocoverage.com/</a> website (the "Service").</p><br />
          ...
          <h6 className='font-bold text-sm'>Personal Data</h6>
          ...
          <ul className='ml-10'>
                <li className='text-sm list-disc'>Email address</li>
                <li className='text-sm list-disc'>First name and last name</li>
                <li className='text-sm list-disc'>Phone number</li>
                <li className='text-sm list-disc'>Cookies and Usage Data</li>
          </ul><br />

          <h6 className='font-bold text-sm'>Usage Data</h6>
          <p>We may also collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p><br />

          <h6 className='font-bold text-sm'>Tracking & Cookies Data</h6>
          ...
          <ul className='ml-10'>
                <li className='text-sm list-disc'> <b>Session Cookies.</b>  We use Session Cookies to operate our Service.</li>
                <li className='text-sm list-disc'> <b>Preference Cookies.</b> We use Preference Cookies to remember your preferences and various settings.</li>
                <li className='text-sm list-disc'> <b>Security Cookies.</b> We use Security Cookies for security purposes.</li>
          </ul><br />

          <h6 className='font-bold text-lg'>Use of Data</h6>
          <p>Dial Auto Coverage uses the collected data for various purposes:</p> <br />
          <ul className='ml-10'>
                <li className='text-sm list-disc'>To provide and maintain the Service</li>
                <li className='text-sm list-disc'>To notify you about changes to our Service</li>
                <li className='text-sm list-disc'>To allow you to participate in interactive features of our Service when you choose to do so</li>
                <li className='text-sm list-disc'>To provide customer care and support</li>
                <li className='text-sm list-disc'>To provide analysis or valuable information so that we can improve the Service</li>
                <li className='text-sm list-disc'>To monitor the usage of the Service</li>
                <li className='text-sm list-disc'>To detect, prevent and address technical issues</li>
          </ul><br />
          <h6 className='font-bold text-lg'>Use of Data</h6>
          ...
          <p>Dial Auto Coverage will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p> <br />
        
          <h6 className='font-bold text-lg'>Disclosure Of Data</h6>
          <h6 className='font-bold text-sm'>Legal Requirements</h6>
          <p>Dial Auto Coverage may disclose your Personal Data in the good faith belief that such action is necessary to:</p><br />
          <ul className='ml-10'>
                <li className='text-sm list-disc'>To comply with a legal obligation</li>
                <li className='text-sm list-disc'>To protect and defend the rights or property of Dial Auto Coverage</li>
                <li className='text-sm list-disc'>To prevent or investigate possible wrongdoing in connection with the Service</li>
                <li className='text-sm list-disc'>To protect the personal safety of users of the Service or the public</li>
                <li className='text-sm list-disc'>To protect against legal liability</li>
          </ul><br />
          ...
          <ul className='ml-10'>
            ...
            <li className="text-sm">For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: https://policies.google.com/privacy?hl=en</li>
          </ul><br />
